...
<main>
    ...
    <section>
        <div>
            <h3 class="text-center">Generate Quotation Bill</h3>
            ...
            <form id="form-gen-bill" action="<?= BASE_DIR; ?>/invoice/gen-inv-bill" method="post">
                <div class="form-group" id="challan-id">

                </div>

                <button class="btn btn-primary mt-4" type="submit">Generate Quote Bill</button>
...
<script>
    ...
    $("#form-gen-bill").submit(function(event) {
        ...
        $.ajax({
            url: "<?= BASE_DIR; ?>/invoice/gen-quote-bill",
            type: "post",
            data: data,
            success: function(result) {
                console.log(result);
    ...
    function retrieveChallanByCustomerId(id) {
        $.ajax({
            url: "<?= BASE_DIR; ?>/challan/retrieveUserQuoteChallan",
            type: "post",
            data: {
                "customer-id": id
            },
