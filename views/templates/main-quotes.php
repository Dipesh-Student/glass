...
<main>
    ...
    <section>
        <div>
            <h3 class="text-center">Quote Manager</h3>
            ...
            <form id="form-add-challan" action="<?= BASE_DIR; ?>/quotes/form-quote-add" method="post">
                ...
                <button class="btn btn-primary" type="submit">Add Quotation</button>
                <button class="btn btn-secondary" type="reset">Reset</button>
            </form>
        </div>
        <div style="display: flex;">
            <div class="left-panel" id="left-panel">
                <a href="<?=BASE_DIR;?>/quotes?page=1">
                    <h2>Quotation-List</h2>
                </a>

                <table class="table" id="list-quotes">
                    <caption>Quotation-List</caption>
                    <tr class="tr">
                        <th>Quotation Id</th>
                        <th>Customer-Id</th>
                        <th>Customer-name</th>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: "<?= BASE_DIR; ?>/quotes/getQuoteList",
            type: "POST",
            data: {
                "startLimit": page,
            ...
            success: function(result) {
                ...
                $.each(jsonResult['data'], function(key, value) {
                    ...
                    <th>${customerName}</th>
                    <th>
                    <a href='http://localhost/glass/public/invoice?challanid=${quoteId}'>Bill/Invoice</a>
